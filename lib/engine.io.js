 ...
 *
 * @param {(Server|http.Server)} engine or server
 * @param {(http.Server|Object)} server or options
 * @param {Object} options
 * @return {Server} engine server
 * @api public
 */

exports.attach = function (engine, server, options) {
  
  if (!(engine instanceof exports.Server)) {
    options = server;
    server = engine;
