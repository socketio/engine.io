...
Server.prototype.handleRequest = function(req, res){
  ...
  this.verify(req, false, function(err, success) {
    if(err === Server.errors.CORS_DISABLED){
      sendAccessControlAllowOriginNone(req, res);
      return;
    }
...
/**
 * Sends an Engine.IO HTTP response with Access-Control-Allow-Origin none
 *
 * @param {http.ServerResponse} response
 * @api private
 */

  function sendAccessControlAllowOriginNone(req, res) {
    var headers = { 'Content-Type': 'application/json' };
